  ...
  return (
    ...
    >
      ...
      <div className="section-inner z-10">
        ...
        <div
          ref={purposeRef}
          className="text-center max-w-[900px] mx-auto mb-32 relative"
        >
          <motion.div
          ...
          >
            ...
            <span className="glass-pill text-white/60 border-white/10 uppercase tracking-widest text-xs">
              OUR PHILOSOPHY
            </span>
          </motion.div>
          ...
          >
            "We cannot force profitability onto you. But we can architect the
            exact environment, resources, and psychological pressure required to
            bring you closer to it."
          </motion.h3>

          <motion.div
            initial={{ opacity: 0, scaleX: 0 }}
            animate={purposeVisible ? { opacity: 1, scaleX: 1 } : {}}
        ...
        <div ref={sectionRef}>
          ...
          >
            <MdAutoAwesome className="text-white/20 mb-6" size={40} />
            <h2 className="heading-display text-4xl md:text-6xl text-white">
              The{" "}
              <span className="italic font-serif text-primary">Game Plan</span>
            </h2>
            <p className="text-white/50 text-lg mt-4 font-light">
              Structure outlasts motivation. This is your 5-day cycle.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {DAILY_SCHEDULE.map((item, i) => (
              ...
              >
                ...
                <h3 className="font-serif text-2xl mb-3 text-white/90 relative z-10">
                  {item.title}
                </h3>
