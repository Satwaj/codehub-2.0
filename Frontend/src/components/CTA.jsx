...
const CTA = () => {
  ...
  return (
    <SectionWrapper
      id="cta"
      className="section-dark-2 relative overflow-hidden py-32 md:py-48"
    ...
    >
      ...
      >
        {icons.map((Icon, i) => (
          <div
            key={i}
            className="cta-icon absolute opacity-10"
            style={{
              left: `${10 + (i % 4) * 25}%`,
      ...
      <div
        ref={sectionRef}
        className="section-inner relative z-10 text-center max-w-[900px] mx-auto px-6"
      >
        <motion.div
        ...
        >
          ...
          <p className="text-text-secondary text-xl md:text-2xl font-light leading-relaxed mb-14 max-w-[600px] mx-auto">
            Take the leap. Connect with verified traders, reconstruct your
            discipline, and compete for pure capital.
          </p>

          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            <a
              href="https://tflclub.com/apply"
              className="btn-gold group relative overflow-hidden px-10 py-4 w-full sm:w-auto"
            >
            ...
            <span className="text-text-secondary text-sm italic font-light">
              or
            </span>
            <a
              href="mailto:contact@tflclub.com"
              className="text-white hover:text-primary transition-colors border-b border-white/20 hover:border-primary pb-1 flex items-center gap-2"
            >
              Speak to Admissions
            </a>
          </div>
